...
public class TestJniInchiStereo0D {
    ...
    protected static JniInchiStereo0D getTestStereo0D() {
        return new JniInchiStereo0D(new NewJniInchiStereo0DAtoms(atC, at0, at1, at2, at3), INCHI_STEREOTYPE.TETRAHEDRAL, INCHI_PARITY.ODD);
    }
    ...
    public void testJniInchiStereo0D() {
        JniInchiStereo0D stereo = new JniInchiStereo0D(new NewJniInchiStereo0DAtoms(atC, at0, at1, at2, at3), INCHI_STEREOTYPE.TETRAHEDRAL, INCHI_PARITY.ODD);
    ...
    public void testGetCentralAtom() {
        JniInchiStereo0D stereo = new JniInchiStereo0D(new NewJniInchiStereo0DAtoms(null, null, null, null, null), null, null);
        Assert.assertNull(stereo.getCentralAtom());
        stereo = new JniInchiStereo0D(new NewJniInchiStereo0DAtoms(atC, null, null, null, null), null, null);
        Assert.assertEquals(atC, stereo.getCentralAtom());
    }
    ...
    public void testGetNeighbors() {
        JniInchiStereo0D stereo = new JniInchiStereo0D(new NewJniInchiStereo0DAtoms(atC, at0, at1, at2, at3), INCHI_STEREOTYPE.TETRAHEDRAL, INCHI_PARITY.EVEN);
    ...
    public void testGetParity() {
        ...
        stereo = new JniInchiStereo0D(new NewJniInchiStereo0DAtoms(atC, at0, at1, at2, at3), INCHI_STEREOTYPE.TETRAHEDRAL, INCHI_PARITY.ODD);
        Assert.assertEquals(INCHI_PARITY.ODD, stereo.getParity());
    }
    ...
    public void testGetStereoType() {
        JniInchiStereo0D stereo = new JniInchiStereo0D(new NewJniInchiStereo0DAtoms(atC, at0, at1, at2, at3), INCHI_STEREOTYPE.TETRAHEDRAL, INCHI_PARITY.EVEN);
        Assert.assertEquals(INCHI_STEREOTYPE.TETRAHEDRAL, stereo.getStereoType());
        stereo = new JniInchiStereo0D(new NewJniInchiStereo0DAtoms(atC, at0, at1, at2, at3), INCHI_STEREOTYPE.ALLENE, INCHI_PARITY.EVEN);
