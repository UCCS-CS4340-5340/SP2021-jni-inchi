...
public class TestJniInchiOutput {
    ...
    public void testGetReturnStatus() {
        JniInchiOutput output = new JniInchiOutput(INCHI_RET.OKAY, new JniInchiOutputStrings(null, null, null, null));
    ...
    public void testGetInchi() {
        JniInchiOutput output = new JniInchiOutput(null, new JniInchiOutputStrings("Inchi=1/C6H6/c1-2-4-6-5-3-1/h1-6H", null, null, null));
    ...
    public void testGetAuxInfo() {
        JniInchiOutput output = new JniInchiOutput(null, new JniInchiOutputStrings(null, "AuxInfo=1/0/N:1,2,6,3,5,4/E:(1,2,3,4,5,6)/rA:6nCCCCCC/rB:d1;s2;d3;s4;s1d5;/rC:-.7145,.4125,0;-.7145,-.4125,0;0,-.825,0;.7145,-.4125,0;.7145,.4125,0;0,.825,0;", null, null));
    ...
    public void testGetMessage() {
        JniInchiOutput output = new JniInchiOutput(null, new JniInchiOutputStrings(null, null, "Test message", null));
    ...
    public void testGetLog() {
        JniInchiOutput output = new JniInchiOutput(null, new JniInchiOutputStrings(null, null, null, "Test log"));
