...
public class JniInchiOutput {
    ...
    public JniInchiOutput(int ret, String inchi, String auxInfo, String message, String log) {
    	this(INCHI_RET.getValue(ret), new JniInchiOutputStrings(inchi, auxInfo, message, log));
    }
    
    public JniInchiOutput(INCHI_RET ret, JniInchiOutputStrings output) {
    	this.retStatus = ret;
    	this.sInchi = output.inchi;
    	this.sAuxInfo = output.auxInfo;
    	this.sMessage = output.message;
    	this.sLog = output.log;
    }
